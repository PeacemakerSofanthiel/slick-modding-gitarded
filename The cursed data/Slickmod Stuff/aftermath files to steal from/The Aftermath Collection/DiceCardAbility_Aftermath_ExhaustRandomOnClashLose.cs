...
// Type: The_Aftermath_Collection.DiceCardAbility_Aftermath_ExhaustRandomOnClashLose
...
namespace The_Aftermath_Collection
{
  public class DiceCardAbility_Aftermath_ExhaustRandomOnClashLose : DiceCardAbilityBase
  {
    ...
    {
      base.OnLoseParrying();
      BattleDiceCardModel battleDiceCardModel = this.owner.allyCardDetail.GetHand().SelectOneRandom<BattleDiceCardModel>();
