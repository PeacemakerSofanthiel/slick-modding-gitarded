...
// Type: The_Aftermath_Collection.PassiveAbility_Aftermath_Enemy_RapidNeutralizationProtocol
  ...
  public class PassiveAbility_Aftermath_Enemy_RapidNeutralizationProtocol : PassiveAbilityBase
  {
    public override void OnSucceedAttack(BattleDiceBehavior behavior)
    {
      ...
      if (activatedBuf == null)
        return;
      this.owner.RecoverHP(activatedBuf.stack);
      this.owner.breakDetail.RecoverBreak(activatedBuf.stack);
    }
