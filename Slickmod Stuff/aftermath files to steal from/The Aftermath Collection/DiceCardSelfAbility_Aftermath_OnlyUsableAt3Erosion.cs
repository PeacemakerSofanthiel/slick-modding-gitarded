...
// Type: The_Aftermath_Collection.DiceCardSelfAbility_Aftermath_OnlyUsableAt3Erosion
...
namespace The_Aftermath_Collection
{
  public class DiceCardSelfAbility_Aftermath_OnlyUsableAt3Erosion : DiceCardSelfAbilityBase
  {
    ...
    public override bool OnChooseCard(BattleUnitModel owner)
    {
      ...
      return activatedBuf != null && activatedBuf.stack >= 3;
    }

    public override void OnUseCard()
    {
      base.OnUseCard();
      this.owner.bufListDetail.GetActivatedBuf(KeywordBuf.Decay).stack -= 3;
