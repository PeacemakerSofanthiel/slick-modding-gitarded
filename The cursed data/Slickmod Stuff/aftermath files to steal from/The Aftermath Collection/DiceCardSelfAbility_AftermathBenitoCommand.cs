...
// Type: The_Aftermath_Collection.DiceCardSelfAbility_AftermathBenitoCommand
  ...
  public class DiceCardSelfAbility_AftermathBenitoCommand : DiceCardSelfAbilityBase
  {
    ...
    public override void OnStartBattle()
    {
      ...
      foreach (BattleUnitModel alive in BattleObjectManager.instance.GetAliveList(this.card.target.faction))
        alive.bufListDetail.AddKeywordBufThisRoundByCard(KeywordBuf.Strength, 1, this.owner);
    }
