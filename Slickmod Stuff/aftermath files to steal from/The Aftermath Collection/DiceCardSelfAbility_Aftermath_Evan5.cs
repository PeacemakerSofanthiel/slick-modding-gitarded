...
// Type: The_Aftermath_Collection.DiceCardSelfAbility_Aftermath_Evan5
...
namespace The_Aftermath_Collection
{
  public class DiceCardSelfAbility_Aftermath_Evan5 : DiceCardSelfAbilityBase
  {
    ...
    public override void OnUseCard()
    {
      ...
      {
        power = Mathf.Min(3, Mathf.RoundToInt((float) (((double) this.owner.MaxHp - (double) this.owner.hp) / 7.0)))
      });
    }
  }
}
